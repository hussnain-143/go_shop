...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('front-end/img/favicon.png') }}">
...
<link rel="stylesheet" href="{{ asset('front-end/css/jquery.mCustomScrollbar.min.css') }}">
<link rel="stylesheet" href="{{ asset('front-end/css/bootstrap-datepicker.min.css') }}">
...
<link rel="stylesheet" href="{{ asset('front-end/css/jarallax.css') }}">
