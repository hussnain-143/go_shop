                        ...
                        <table id="example2" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>{{ $item->name }}</td>
                                    <td>{{ $item->parentCategory ? $item->parentCategory->name : 'No Parent Category' }}</td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger px-3"
                                            onclick="Delete({{ json_encode($item) }}, 'categories')" >Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal fade" id="exampleLargeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ Route('admin.category.store') }}" id="formSubmit" >
                    @csrf
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        ...
                        <div class="card border-top border-0 mt-4 border-4 border-primary">
                            <div class="card-body">
                                <hr />
                                <div class="row mb-3">
                                    <label for="text" class="col-sm-3 col-form-label">Enter Name</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    <label for="link" class="col-sm-3 col-form-label">Enter Slug</label>
                                    <div class="col-sm-9">
