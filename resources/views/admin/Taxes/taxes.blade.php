...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!-- Section -->
            <h6 class="mb-0 text-uppercase">Manage Tax</h6>
            <hr />
            <div class="col my-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger px-3"
                                            onclick="Delete({{ json_encode($item) }}, 'taxes')" >Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal fade" id="exampleLargeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ Route('admin.tax.store') }}" id="formSubmit" >
                    @csrf
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        ...
                        <div class="card border-top border-0 mt-4 border-4 border-primary">
                            <div class="card-body">
                                <hr />
                                <div class="row mb-3">
                                    <label for="text" class="col-sm-3 col-form-label">Enter Tax</label>
                                    <div class="col-sm-9">
